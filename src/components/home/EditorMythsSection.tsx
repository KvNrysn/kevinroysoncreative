...
const myths = [
  ...
  },
  {
    ...
    detail:
      "When visuals reinforce the message, trust builds — and when they distract or misalign, doubt creeps in. Even subconsciously.",
    span: "md:col-span-1 md:row-span-1",
  },
  {
    image: mythMusic,
          ...
          {myths.map((myth, i) => {
            ...
            return (
              <div key={i} className="flex flex-col">
                {/* Label above the card for first row */}
                {i < 2 && (
                  <p className="text-xs text-muted-foreground/60 text-center mb-3 font-medium uppercase tracking-widest">
                    {myth.label}
                  </p>
                )}
                ...
                <motion.div
                  ...
                  className={`group relative rounded-2xl border border-border overflow-hidden transition-all duration-500 hover:border-primary/30 ${myth.span} flex-1`}
                ...
                {/* Label below the card for second row */}
                {i >= 2 && (
                  <p className="text-xs text-muted-foreground/60 text-center mt-3 font-medium uppercase tracking-widest">
                    {myth.label}
                  </p>
                )}
              </div>
