          ...
          <div className="r r-d3" style={{ border: "1px solid var(--line)", background: "var(--bg)", overflow: "hidden", marginTop: 80 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 380px", borderBottom: "1px solid var(--line)" }} className="cs-story-grid">
              <div style={{ padding: 40, paddingRight: 40 }}>
                <p style={{ fontSize: 16, lineHeight: 1.75 }}>Ritesh runs Agent Rise, a mentorship program for founders scaling to 6–7 figures. YouTube was his main lead source, but production was eating his time and every video meant another round of briefing and revisions.<br /><br />We built one consistent post-production system around his content and locked the style into a single SOP so it shipped consistently with near-zero revision rounds, and he could step back without the channel stalling.<br /><br />Results depend on the creator's offer and audience, and nothing here is a guarantee. But over the period we worked together, the channel kept shipping on his recorded content while his mentorship grew to 200+ members without him chasing it or briefing every video.</p>
              </div>
